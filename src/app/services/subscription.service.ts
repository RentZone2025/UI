...
export class SubscriptionService {
  ...
  getSubscriptionPlans(){
    return this.http.get(`${this.API_URL}/subscriptions/plans`, {
      headers: {
  ...
  createCheckoutSession(price_id: string){
    return this.http.post(`${this.API_URL}/subscriptions/create-checkout-session`, {
      price_id: price_id
    }, {
      headers: {
        'Authorization': `Bearer ${getToken()}`
  ...
  saveSubscription(sessionId: string){
    return this.http.post(`${this.API_URL}/subscriptions/`, {
